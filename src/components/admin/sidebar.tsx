...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`fixed left-0 top-0 h-screen bg-jungle-dark border-r border-white/10 flex flex-col z-40 transition-all duration-300 ${
        collapsed ? "w-16" : "w-60"
      }`}
    >
      {/* Logo */}
      ...
      <div className="border-t border-white/10 p-2 space-y-1">
        ...
        <button
          onClick={toggle}
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm text-beige/40 hover:text-white hover:bg-white/5 transition-colors"
        >
        ...
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm text-beige/40 hover:text-red-400 hover:bg-red-500/5 transition-colors"
        >
