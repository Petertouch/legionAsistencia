...
export default function NuevoProfesorPage() {
  ...
  return (
    <div className="space-y-4 max-w-lg">
      <Link href="/admin/profesores" className="inline-flex items-center gap-1.5 text-beige/40 text-sm hover:text-white transition-colors">
        <ArrowLeft className="w-4 h-4" /> Profesores
      </Link>

      <h1 className="text-white text-xl font-bold">Nuevo profesor</h1>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-4">
          ...
          {form.avatar_url ? (
            <div className="flex items-center gap-4 mt-2">
              ...
              <div>
                <p className="text-beige/50 text-xs mb-2">Foto subida</p>
            ...
            <label className={`flex flex-col items-center justify-center gap-2 py-8 mt-1 border-2 border-dashed border-white/10 hover:border-purple-500/30 rounded-xl cursor-pointer transition-colors group ${uploading ? "pointer-events-none opacity-60" : ""}`}>
              {uploading ? (
                ...
                <div className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-purple-500/10 transition-colors">
                  <Upload className="w-6 h-6 text-beige/30 group-hover:text-purple-400 transition-colors" />
                </div>
              )}
