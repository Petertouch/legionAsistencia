...
export default function NuevoVendedorPage() {
  ...
  const [password, setPassword] = useState("legion2026");
  ...
  return (
    <div className="max-w-lg space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-white text-xl font-bold">Nuevo vendedor</h1>
          <p className="text-beige/40 text-sm mt-0.5">Se le asignará un código único para su link de referido</p>
        </div>
      </div>
