            ...
            <Stagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4" staggerDelay={0.08}>
              {[
                ...
                },
                {
                  ...
                  desc: "Tu carrera de años puede terminar por un proceso mal gestionado.",
                  icon: (
                    <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            {[
              {
                ...
                desc: "Base, Plus o Elite. Todos incluyen asesoría ilimitada. Escoge según tus necesidades.",
                icon: (
              ...
              },
              {
                ...
                desc: "WhatsApp, llamada o en persona. Sin citas previas. Tu abogado siempre está ahí.",
                icon: (
                  <svg className="w-6 h-6 sm:w-8 sm:h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
