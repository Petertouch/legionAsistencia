...
const PROTECTED_API_PREFIXES = ["/api/suscriptores", "/api/mail", "/api/upload", "/api/heygen"];
...
export const config = {
  matcher: ["/admin/:path*", "/login", "/api/suscriptores/:path*", "/api/mail/:path*", "/api/upload/:path*", "/api/heygen/:path*"],
};
